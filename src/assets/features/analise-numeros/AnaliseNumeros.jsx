...
export async function processarSorteios()
{
  ...
  const numerosRepetidoUmaVez = repeatedElements['1'].sort((a, b) => a - b);
  const numerosRepetidoDuasVez = repeatedElements['2'].sort((a, b) => a - b);
  const numerosRepetidoTresVez = repeatedElements['3'].sort((a, b) => a - b);
  const numerosRepetidoQuatroVez = repeatedElements['4'].sort((a, b) => a - b);
  ...
  const numbersNotDrawn = allNumbers.filter(number => !allElements.includes(number));

  return {
    numerosRepetidoUmaVez,
    numerosRepetidoDuasVez,
    numerosRepetidoTresVez,
    numerosRepetidoQuatroVez,
    numbersNotDrawn
  };
}
